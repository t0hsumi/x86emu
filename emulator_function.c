...
int32_t is_carry(Emulator *emu) { return (emu->eflags & CARRY_FLAG) != 0; }
int32_t is_zero(Emulator *emu) { return (emu->eflags & ZERO_FLAG) != 0; }
int32_t is_sign(Emulator *emu) { return (emu->eflags & SIGN_FLAG) != 0; }
